...
function enqueueRender(component) {
  ...
  if (component._dirty) {
    shouldProcess = prevDebounce !== options["default"].debounceRendering;
  } else {
  ...
  if (shouldProcess) {
    ...
    prevDebounce = options["default"].debounceRendering;
...
function diff(parentNode, remoteRoot, newVNode, oldVNode, globalContext, excessRemoteChildren, commitQueue, oldRemoteNode) {
  ...
  (_options$_diff = options["default"]._diff) === null || _options$_diff === void 0 ? void 0 : _options$_diff.call(options["default"], newVNode);
  ...
  try {
    ...
    outer: if (typeof newType === 'function') {
      ...
      (_options$_render = options["default"]._render) === null || _options$_render === void 0 ? void 0 : _options$_render.call(options["default"], newVNode);
      component._dirty = false;
      component._vnode = newVNode;
      ...
      const normalizedRenderResult = renderResult == null || renderResult.type !== Fragment.Fragment || renderResult.key != null ? renderResult : renderResult.props.children; // Handle setState called in render
    ...
    (_options$diffed = options["default"].diffed) === null || _options$diffed === void 0 ? void 0 : _options$diffed.call(options["default"], newVNode);
  } catch (error) {
    ...
    options["default"]._catchError(error, newVNode, oldVNode);
  }
...
function commitRoot(commitQueue, vnode) {
  ...
  (_options$_commit = options["default"]._commit) === null || _options$_commit === void 0 ? void 0 : _options$_commit.call(options["default"], vnode, commitQueue);
  commitQueue.forEach(component => {
    try {
      ...
      options["default"]._catchError(error, component._vnode);
    }
  });
}
/**
...
function unmount(vnode, parentVNode, skipRemove = false) {
  ...
  (_options$unmount = options["default"].unmount) === null || _options$unmount === void 0 ? void 0 : _options$unmount.call(options["default"], vnode);
  const {
    ref,
    type,
  ...
  if (component != null) {
    if (component.componentWillUnmount) {
      try {
        ...
        options["default"]._catchError(error, parentVNode);
      }
    }
...
function diffElementNodes(remoteNode, remoteRoot, newVNode, oldVNode, globalContext, excessChildren, commitQueue) {
  ...
  if (excessChildren != null) {
    for (const child of excessChildren) {
      ...
      if (child != null && ((newVNode.type === null ? child.kind === core.KIND_TEXT : child.type === newVNode.type) || remoteNode === child)) {
  ...
  if (newVNode.type === null) {
    ...
    props.diffProps(resolvedRemoteNode, newProps, oldProps !== null && oldProps !== void 0 ? oldProps : {});
    const {
      children
    } = newProps;
...
function applyRef(ref, value, vnode) {
  try {
    ...
    options["default"]._catchError(error, vnode);
  }
}
...
function diffChildren(parentNode, remoteRoot, renderResult, newParentVNode, oldParentVNode, globalContext, excessRemoteChildren, commitQueue, oldRemoteNode) {
  ...
  const oldChildren = (_oldParentVNode$_chil = oldParentVNode === null || oldParentVNode === void 0 ? void 0 : oldParentVNode._children) !== null && _oldParentVNode$_chil !== void 0 ? _oldParentVNode$_chil : constants.EMPTY_ARRAY;
  ...
  for (index = 0; index < renderResult.length; index++) {
    ...
    if (rendered == null || typeof rendered === 'boolean') {
      ...
      childVNode = createElement.createVNode(null, rendered, null, undefined, rendered);
    } else if (Array.isArray(rendered)) {
      childVNode = createElement.createVNode(Fragment.Fragment, {
        children: rendered
      }, null, undefined, null);
    } else if (rendered._remoteNode != null || rendered._component != null) {
      childVNode = createElement.createVNode(rendered.type, rendered.props, rendered.key, undefined, rendered._original);
    } else {
      childVNode = rendered;
    }
  ...
  if (excessRemoteChildren != null && typeof newParentVNode.type !== 'function') {
    for (let index = excessRemoteChildren.length; index--;) {
      if (excessRemoteChildren[index] != null) {
        utilities.removeNode(excessRemoteChildren[index]);
      }
    }
