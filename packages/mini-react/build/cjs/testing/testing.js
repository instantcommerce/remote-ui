...
var environment = require('@quilted/react-testing/environment');
...
const {
  ...
  mount(tree) {
    const root = core.createRemoteRoot(() => {});
...
exports.act = act.act;
exports.setupRerender = act.setupRerender;
exports.teardown = act.teardown;
